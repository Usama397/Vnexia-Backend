...
<body class="dashboard-layout">
    ...
    <script>
            document.addEventListener('DOMContentLoaded', function () {
    let temporarilySelectedIcon = '';  // Temporary storage for the selected icon
    ...
    iconContainer.addEventListener('click', function (e) {
        if (e.target && e.target.matches('.icon-option')) {
            ...
            temporarilySelectedIcon = selectedIcon;
    ...
    selectIconButton.addEventListener('click', function () {
        if (temporarilySelectedIcon) {
            // Update the hidden input with the selected icon class
            document.getElementById('selectedIconInput').value = temporarilySelectedIcon;

            // Update the preview in the main modal
            document.getElementById('selectedIconPreview').className = temporarilySelectedIcon;

            // Close the icon modal
